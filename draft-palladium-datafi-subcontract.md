...
4. **Build deployment into the product.** We believe that GHSD currently has no dedicated technical team for this. Rather than rely on consultants, we intend for this toolkit to ship with: a facilitation guide any TA partner can use to run a 2-day workshop; validation through the eHealth Leaders Forum as a launch pad; a simple digital self-assessment (Google Sheet or lightweight web app) so any country team can assess themselves without a consultant; and integration hooks into Global Fund, PEPFAR, and World Bank monitoring frameworks.
