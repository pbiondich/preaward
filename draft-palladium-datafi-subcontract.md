...
2. **Solve an acute pain.** The pain is already clear: 95% of systems are "transitioning" but nobody clearly is defin what that meant. Implementing partners cannot plan for an undefined target. Countries cannot demand what they cannot articulate. State cannot hold anyone accountable. The toolkit's job is not to be comprehensive — it is to give every stakeholder a single answer to "are we there yet?" on each dimension.
