...
1. Defines country ownership of digital health systems across multiple dimensions: 
   - **Financial Ownership:** countries funding their own digital health line items rather than relying on donor project budgets. Currently most systems run on extproject budgets with expiration dates. Real ownership means ministry budget lines, pooled domestic financing, and transition plans with actual fiscal timelines — not just a handover date.
