...
1. Defines country ownership of digital health systems across six dimensions, each can be assessed on a maturity spectrum: 
...
2. **One page, not a document.** The centerpiece of the toolkit is the Country Ownership Spectrum: a single visual with six axes (Financial, Technical, Governance, Data, Procurement, Political), each on a 1–5 maturity scale. A country team plots themselves, and walks out with something they can reference and/or use in their next donor meeting. The rest of the toolkit is further reference material.
...
A critical design principle: while this is a State Department publication, its north star is simple: would a Ministry of Health find this useful? The toolkit must be credible in Washington, but it must be adopted in countries as well. We therefore think it's important to emphasize participatory development within the eHealth Leaders Forum, ministries of health, and in-country users to develop this toolkit.
...
- Weeks 3–4: Stakeholder consultation design and initial engagements — select a pilot country as first use case
