...
2. **One page, not a document.** The centeris the Country Ownership Spectrum: a single visual with six axes (Financial, Technical, Governance, Data, Procurement, Political), each on a 1–5 maturity scale. A country team plots themselves, and walks out with something they can reference and/or use in their next donor meeting. The rest of the toolkit is further reference material.
