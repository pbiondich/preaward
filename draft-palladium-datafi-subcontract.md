...
1. **One page, not a document.** The artifact that likely has the most long term impact is the Country Ownership Spectrum: a single visual with six axes (Financial, Technical, Governance, Data, Procurement, Political), each on a 1–5 maturity scale. A country team plots themselves, and walks out with something they can reference and/or use in their next donor meeting. The rest of the toolkit is further reference material.
2. **Solve an acute problem.** The pain is already clear: 95% of systems are "transitioning" but nobody clearly is defining what that means. Implementing partners cannot plan for an undefined target. Countries cannot demand what they cannot articulate. State cannot hold anyone accountable. The toolkit's job is not to be comprehensive, it is to give every stakeholder a single answer to "are we there yet?" on each dimension.
