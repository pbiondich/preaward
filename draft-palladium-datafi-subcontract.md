...
1. **One page, not a document.** The artifact that likely has the mos is the Country Ownership Spectrum — a single visual with six axes (Financial, Technical, Governance, Data, Procurement, Political), each on a 1–5 maturity scale. A country team plots themselves, gets a radar chart, and walks out with something they can pin on a wall and use in their next donor meeting. The rest of the toolkit is the user manual for that one page.
